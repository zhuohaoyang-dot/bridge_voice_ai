...
document.addEventListener('DOMContentLoaded', () => {
    console.log('Bridge Legal Call System initializing...');
...
async function loadComponents() {
    try {
        ...
        // Load leads panel
        const leadsResponse = await fetch('components/leads-panel.html');
        const leadsHtml = await leadsResponse.text();
        document.getElementById('leads-panel').innerHTML = leadsHtml;
